...
import com.skybox.utils.ProcessUtils;
import com.skybox.utils.ScaleFilter;
...
public class FileInfoServiceImpl implements FileInfoService {
     ...
     * @description 处理文件上传请求，并在数据库中记录文件信息
     */
    @Override
     ...
     * @param videoFilePath
     * @return void
     * @description 对视频文件进行切割操作，生成切片文件和索引文件
     */
     ...
     * @param fileName
     * @return FileInfo
     * @description 重命名文件，并更新数据库中对应文件的信息
     */
    @Override
    @Transactional(rollbackFor = Exception.class)
     ...
     * @param folderName
     * @return FileInfo
     * @description 创建新的文件夹，并将其添加到数据库中
     */
    @Override
    @Transactional(rollbackFor = Exception.class)
