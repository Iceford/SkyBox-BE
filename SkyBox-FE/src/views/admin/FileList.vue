<!--
 * @Description: 用于创建一个文件列表页面
 * @FilePath: \SkyBox-FE\src\views\admin\FileList.vue
 * @Author: WhimsyQuester rongquanhuang01@gmail.com
 * @Date: 2023-11-14 17:22:56
 * @LastEditors: WhimsyQuester rongquanhuang01@gmail.com
 * @LastEditTime: 2023-12-08 21:28:39
...
<template>
    <div>
        <div class="top">
            <div class="top-op">
                <!-- 顶部搜索栏：包括一个可清空的输入框和搜索按钮，用于输入文件名并进行搜索 -->
                ...
                <!-- 刷新按钮：点击该按钮可以重新加载文件列表数据 -->
                <div class="iconfont icon-refresh" @click="loadDataList"></div>
                <!-- 批量删除按钮：只有在选择了至少一个文件时才可点击，用于批量删除选中的文件 -->
            ...
            <!-- 导航栏：显示文件列表的导航栏，可以切换到不同的文件夹 -->
            <Navigation ref="navigationRef" @navChange="navChange" :adminShow="true"></Navigation>
        </div>
        <!-- 文件列表：展示文件的表格，包含文件名、发布人、修改时间和大小等列，同时支持分页和选择多个文件进行操作 -->
        <div class="file-list">
