 ...
 * @FilePath: \SkyBox-FE\src\views\main\Uploader.vue
 * @Author: WhimsyQuester rongquanhuang01@gmail.com
 * @Date: 2023-11-14 19:35:55
 * @LastEditors: WhimsyQuester rongquanhuang01@gmail.com
 * @LastEditTime: 2023-11-14 19:36:04
                ...
                <div class="op">
                    ...
                    <div class="op-btn">
                        <span v-if="item.status === STATUS.uploading.value">
                            ...
                            <icon :width="28" class="btn-item" iconName="pause" title="暂停" @click="pauseUpload(item.uid)"
                                v-else></icon>
                        </span>
                        <icon :width="28" class="del btn-item" iconName="del" title="删除" v-if="item.status != STATUS.init.value &&
                            item.status != STATUS.upload_finish.value &&
                            item.status != STATUS.upload_seconds.value
